...
Generated: `2026-05-13T17:56:24.209254+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T175611Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 6.694 | 63.257 | 0.127 | 1.402 | 0.023 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 6.876 | 65.588 | 0.137 | 1.204 | 0.025 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 6.606 | 19.912 | 0.126 | 1.541 | 0.02 | 8e-06 | 8e-06 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 6.053 | 7.639 | 0.131 | 1.246 | 0.024 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 6.118 | 6.6 | 0.12 | 1.206 | 0.025 | 1e-05 | 1e-05 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 6.694 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 6.694 | 60 |
| Throttle | 8e-06 | 8e-06 | 6.694 | 60 |
| Yaw | 2e-05 | 2e-05 | 6.694 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 6.694 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 6.694 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 6.876 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 6.876 | 60 |
| Throttle | 8e-06 | 8e-06 | 6.876 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 6.876 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 6.876 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 6.876 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 6.053 | 96 |
| Pitch | 1e-05 | 1e-05 | 6.053 | 96 |
| Throttle | 6e-06 | 6e-06 | 6.053 | 96 |
| Yaw | 9e-06 | 9e-06 | 6.053 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 6.053 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 6.053 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 6.118 | 2 |
| Pitch | 4e-06 | 4e-06 | 6.118 | 2 |
| Throttle | 4e-06 | 4e-06 | 6.118 | 2 |
| Yaw | 1e-05 | 1e-05 | 6.118 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 6.118 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 6.118 | 2 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 6.606 | 45 |
| B2 | Out2 | 1 | 1 | 6.606 | 45 |
| B3 | Out3 | 1 | 1 | 6.606 | 45 |
| B4 | Out4 | 1 | 1 | 6.606 | 45 |
| B5 | Out5 | 1 | 1 | 6.606 | 45 |
| B6 | Out6 | 1 | 1 | 6.606 | 45 |
| B7 | Out7 | 1 | 1 | 6.606 | 45 |
| B8 | Out8 | 1 | 1 | 6.606 | 45 |
| B9 | Out9 | 1 | 1 | 6.606 | 45 |
| B10 | Out10 | 1 | 1 | 6.606 | 45 |
| B11 | Out11 | 1 | 1 | 6.606 | 45 |
| B12 | Out12 | 1 | 1 | 6.606 | 45 |
| B13 | Out13 | 1 | 1 | 6.606 | 45 |
| B14 | Out14 | 1 | 1 | 6.606 | 45 |
| B15 | Out15 | 1 | 1 | 6.606 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 6.118 | 2 |
...
| B8 | Out8 | 0 | 0 | 6.118 | 2 |
| B9 | Out9 | 0 | 0 | 6.118 | 2 |
| B10 | Out10 | 0 | 0 | 6.118 | 2 |
| B11 | Out11 | 0 | 0 | 6.118 | 2 |
| B12 | Out12 | 0 | 0 | 6.118 | 2 |
| B13 | Out13 | 0 | 0 | 6.118 | 2 |
| B14 | Out14 | 0 | 0 | 6.118 | 2 |
| B15 | Out15 | 0 | 0 | 6.118 | 2 |
