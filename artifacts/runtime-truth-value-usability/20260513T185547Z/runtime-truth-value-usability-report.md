...
Generated: `2026-05-13T18:56:02.780542+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T185547Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 6.101 | 32.95 | 0.103 | 1.061 | 0.02 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 7.004 | 21.655 | 0.111 | 1.003 | 0.019 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 7.223 | 22.096 | 0.119 | 1.32 | 0.019 | 8e-06 | 8e-06 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 6.825 | 23.169 | 0.115 | 1.132 | 0.021 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 4.681 | 4.889 | 0.104 | 0.956 | 0.018 | 1e-05 | 1e-05 |
| `axis_sine_real_vjoy` | `real_vjoy` | 72 | 73 | 1.0 | 10.569 | 25.005 | 0.124 | 2.614 | 0.852 | 2e-05 | 2e-05 |
| `buttons_toggle_real_vjoy` | `real_vjoy` | 45 | 46 | 1.0 | 10.736 | 26.924 | 0.126 | 3.015 | 1.207 | 8e-06 | 8e-06 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 6.101 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 6.101 | 60 |
| Throttle | 8e-06 | 8e-06 | 6.101 | 60 |
| Yaw | 2e-05 | 2e-05 | 6.101 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 6.101 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 6.101 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 7.004 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 7.004 | 60 |
| Throttle | 8e-06 | 8e-06 | 7.004 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 7.004 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 7.004 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 7.004 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 6.825 | 96 |
| Pitch | 1e-05 | 1e-05 | 6.825 | 96 |
| Throttle | 6e-06 | 6e-06 | 6.825 | 96 |
| Yaw | 9e-06 | 9e-06 | 6.825 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 6.825 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 6.825 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 4.681 | 2 |
| Pitch | 4e-06 | 4e-06 | 4.681 | 2 |
| Throttle | 4e-06 | 4e-06 | 4.681 | 2 |
| Yaw | 1e-05 | 1e-05 | 4.681 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 4.681 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 4.681 | 2 |
### axis_sine_real_vjoy
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 10.569 | 72 |
| Pitch | 1.7e-05 | 1.7e-05 | 10.569 | 72 |
| Throttle | 7e-06 | 7e-06 | 10.569 | 72 |
| Yaw | 2e-05 | 2e-05 | 10.569 | 72 |
| Aux 1 | 1.5e-05 | 1.5e-05 | 10.569 | 72 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 10.569 | 72 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 7.223 | 45 |
| B2 | Out2 | 1 | 1 | 7.223 | 45 |
| B3 | Out3 | 1 | 1 | 7.223 | 45 |
| B4 | Out4 | 1 | 1 | 7.223 | 45 |
| B5 | Out5 | 1 | 1 | 7.223 | 45 |
| B6 | Out6 | 1 | 1 | 7.223 | 45 |
| B7 | Out7 | 1 | 1 | 7.223 | 45 |
| B8 | Out8 | 1 | 1 | 7.223 | 45 |
| B9 | Out9 | 1 | 1 | 7.223 | 45 |
| B10 | Out10 | 1 | 1 | 7.223 | 45 |
| B11 | Out11 | 1 | 1 | 7.223 | 45 |
| B12 | Out12 | 1 | 1 | 7.223 | 45 |
| B13 | Out13 | 1 | 1 | 7.223 | 45 |
| B14 | Out14 | 1 | 1 | 7.223 | 45 |
| B15 | Out15 | 1 | 1 | 7.223 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 4.681 | 2 |
...
| B8 | Out8 | 0 | 0 | 4.681 | 2 |
| B9 | Out9 | 0 | 0 | 4.681 | 2 |
| B10 | Out10 | 0 | 0 | 4.681 | 2 |
| B11 | Out11 | 0 | 0 | 4.681 | 2 |
| B12 | Out12 | 0 | 0 | 4.681 | 2 |
| B13 | Out13 | 0 | 0 | 4.681 | 2 |
| B14 | Out14 | 0 | 0 | 4.681 | 2 |
| B15 | Out15 | 0 | 0 | 4.681 | 2 |
### buttons_toggle_real_vjoy
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 10.736 | 45 |
| B2 | Out2 | 1 | 1 | 10.736 | 45 |
| B3 | Out3 | 1 | 1 | 10.736 | 45 |
| B4 | Out4 | 1 | 1 | 10.736 | 45 |
| B5 | Out5 | 1 | 1 | 10.736 | 45 |
| B6 | Out6 | 1 | 1 | 10.736 | 45 |
| B7 | Out7 | 1 | 1 | 10.736 | 45 |
| B8 | Out8 | 1 | 1 | 10.736 | 45 |
| B9 | Out9 | 1 | 1 | 10.736 | 45 |
| B10 | Out10 | 1 | 1 | 10.736 | 45 |
| B11 | Out11 | 1 | 1 | 10.736 | 45 |
| B12 | Out12 | 1 | 1 | 10.736 | 45 |
| B13 | Out13 | 1 | 1 | 10.736 | 45 |
| B14 | Out14 | 1 | 1 | 10.736 | 45 |
| B15 | Out15 | 1 | 1 | 10.736 | 45 |
