...
Generated: `2026-05-13T17:56:49.776313+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T175633Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 6.043 | 20.108 | 0.124 | 1.273 | 0.024 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 6.658 | 61.75 | 0.128 | 1.246 | 0.025 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 6.154 | 17.29 | 0.121 | 1.456 | 0.02 | 8e-06 | 8e-06 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 6.811 | 12.489 | 0.149 | 1.417 | 0.024 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 6.854 | 7.154 | 0.131 | 1.27 | 0.022 | 1e-05 | 1e-05 |
| `axis_sine_real_vjoy` | `real_vjoy` | 72 | 73 | 1.0 | 9.432 | 12.248 | 0.135 | 3.343 | 1.202 | 2e-05 | 2e-05 |
| `buttons_toggle_real_vjoy` | `real_vjoy` | 45 | 46 | 1.0 | 10.722 | 63.312 | 0.129 | 3.486 | 1.357 | 8e-06 | 8e-06 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 6.043 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 6.043 | 60 |
| Throttle | 8e-06 | 8e-06 | 6.043 | 60 |
| Yaw | 2e-05 | 2e-05 | 6.043 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 6.043 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 6.043 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 6.658 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 6.658 | 60 |
| Throttle | 8e-06 | 8e-06 | 6.658 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 6.658 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 6.658 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 6.658 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 6.811 | 96 |
| Pitch | 1e-05 | 1e-05 | 6.811 | 96 |
| Throttle | 6e-06 | 6e-06 | 6.811 | 96 |
| Yaw | 9e-06 | 9e-06 | 6.811 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 6.811 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 6.811 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 6.854 | 2 |
| Pitch | 4e-06 | 4e-06 | 6.854 | 2 |
| Throttle | 4e-06 | 4e-06 | 6.854 | 2 |
| Yaw | 1e-05 | 1e-05 | 6.854 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 6.854 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 6.854 | 2 |
### axis_sine_real_vjoy
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 9.432 | 72 |
| Pitch | 1.7e-05 | 1.7e-05 | 9.432 | 72 |
| Throttle | 7e-06 | 7e-06 | 9.432 | 72 |
| Yaw | 2e-05 | 2e-05 | 9.432 | 72 |
| Aux 1 | 1.5e-05 | 1.5e-05 | 9.432 | 72 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 9.432 | 72 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 6.154 | 45 |
| B2 | Out2 | 1 | 1 | 6.154 | 45 |
| B3 | Out3 | 1 | 1 | 6.154 | 45 |
| B4 | Out4 | 1 | 1 | 6.154 | 45 |
| B5 | Out5 | 1 | 1 | 6.154 | 45 |
| B6 | Out6 | 1 | 1 | 6.154 | 45 |
| B7 | Out7 | 1 | 1 | 6.154 | 45 |
| B8 | Out8 | 1 | 1 | 6.154 | 45 |
| B9 | Out9 | 1 | 1 | 6.154 | 45 |
| B10 | Out10 | 1 | 1 | 6.154 | 45 |
| B11 | Out11 | 1 | 1 | 6.154 | 45 |
| B12 | Out12 | 1 | 1 | 6.154 | 45 |
| B13 | Out13 | 1 | 1 | 6.154 | 45 |
| B14 | Out14 | 1 | 1 | 6.154 | 45 |
| B15 | Out15 | 1 | 1 | 6.154 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 6.854 | 2 |
...
| B8 | Out8 | 0 | 0 | 6.854 | 2 |
| B9 | Out9 | 0 | 0 | 6.854 | 2 |
| B10 | Out10 | 0 | 0 | 6.854 | 2 |
| B11 | Out11 | 0 | 0 | 6.854 | 2 |
| B12 | Out12 | 0 | 0 | 6.854 | 2 |
| B13 | Out13 | 0 | 0 | 6.854 | 2 |
| B14 | Out14 | 0 | 0 | 6.854 | 2 |
| B15 | Out15 | 0 | 0 | 6.854 | 2 |
### buttons_toggle_real_vjoy
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 10.722 | 45 |
| B2 | Out2 | 1 | 1 | 10.722 | 45 |
| B3 | Out3 | 1 | 1 | 10.722 | 45 |
| B4 | Out4 | 1 | 1 | 10.722 | 45 |
| B5 | Out5 | 1 | 1 | 10.722 | 45 |
| B6 | Out6 | 1 | 1 | 10.722 | 45 |
| B7 | Out7 | 1 | 1 | 10.722 | 45 |
| B8 | Out8 | 1 | 1 | 10.722 | 45 |
| B9 | Out9 | 1 | 1 | 10.722 | 45 |
| B10 | Out10 | 1 | 1 | 10.722 | 45 |
| B11 | Out11 | 1 | 1 | 10.722 | 45 |
| B12 | Out12 | 1 | 1 | 10.722 | 45 |
| B13 | Out13 | 1 | 1 | 10.722 | 45 |
| B14 | Out14 | 1 | 1 | 10.722 | 45 |
| B15 | Out15 | 1 | 1 | 10.722 | 45 |
