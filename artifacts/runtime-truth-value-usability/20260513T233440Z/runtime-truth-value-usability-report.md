...
Generated: `2026-05-13T23:34:54.938393+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T233440Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 5.655 | 26.268 | 0.096 | 1.032 | 0.017 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 5.269 | 32.306 | 0.087 | 0.868 | 0.015 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 4.947 | 14.538 | 0.08 | 1.085 | 0.014 | 0.053974 | 0.053974 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 5.166 | 14.128 | 0.088 | 1.0 | 0.016 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 4.234 | 5.074 | 0.114 | 0.873 | 0.015 | 1e-05 | 1e-05 |
| `axis_sine_real_vjoy` | `real_vjoy` | 72 | 73 | 1.0 | 8.495 | 17.348 | 0.09 | 1.982 | 0.619 | 2e-05 | 2e-05 |
| `buttons_toggle_real_vjoy` | `real_vjoy` | 45 | 46 | 1.0 | 7.985 | 17.592 | 0.086 | 2.264 | 0.867 | 0.053974 | 0.053974 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 5.655 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 5.655 | 60 |
| Throttle | 8e-06 | 8e-06 | 5.655 | 60 |
| Yaw | 2e-05 | 2e-05 | 5.655 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 5.655 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 5.655 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 5.269 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 5.269 | 60 |
| Throttle | 8e-06 | 8e-06 | 5.269 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 5.269 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 5.269 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 5.269 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 5.166 | 96 |
| Pitch | 1e-05 | 1e-05 | 5.166 | 96 |
| Throttle | 6e-06 | 6e-06 | 5.166 | 96 |
| Yaw | 9e-06 | 9e-06 | 5.166 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 5.166 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 5.166 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 4.234 | 2 |
| Pitch | 4e-06 | 4e-06 | 4.234 | 2 |
| Throttle | 4e-06 | 4e-06 | 4.234 | 2 |
| Yaw | 1e-05 | 1e-05 | 4.234 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 4.234 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 4.234 | 2 |
### axis_sine_real_vjoy
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 8.495 | 72 |
| Pitch | 1.7e-05 | 1.7e-05 | 8.495 | 72 |
| Throttle | 7e-06 | 7e-06 | 8.495 | 72 |
| Yaw | 2e-05 | 2e-05 | 8.495 | 72 |
| Aux 1 | 1.5e-05 | 1.5e-05 | 8.495 | 72 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 8.495 | 72 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 4.947 | 45 |
| B2 | Out2 | 1 | 1 | 4.947 | 45 |
| B3 | Out3 | 1 | 1 | 4.947 | 45 |
| B4 | Out4 | 1 | 1 | 4.947 | 45 |
| B5 | Out5 | 1 | 1 | 4.947 | 45 |
| B6 | Out6 | 1 | 1 | 4.947 | 45 |
| B7 | Out7 | 1 | 1 | 4.947 | 45 |
| B8 | Out8 | 1 | 1 | 4.947 | 45 |
| B9 | Out9 | 1 | 1 | 4.947 | 45 |
| B10 | Out10 | 1 | 1 | 4.947 | 45 |
| B11 | Out11 | 1 | 1 | 4.947 | 45 |
| B12 | Out12 | 1 | 1 | 4.947 | 45 |
| B13 | Out13 | 1 | 1 | 4.947 | 45 |
| B14 | Out14 | 1 | 1 | 4.947 | 45 |
| B15 | Out15 | 1 | 1 | 4.947 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 4.234 | 2 |
...
| B8 | Out8 | 0 | 0 | 4.234 | 2 |
| B9 | Out9 | 0 | 0 | 4.234 | 2 |
| B10 | Out10 | 0 | 0 | 4.234 | 2 |
| B11 | Out11 | 0 | 0 | 4.234 | 2 |
| B12 | Out12 | 0 | 0 | 4.234 | 2 |
| B13 | Out13 | 0 | 0 | 4.234 | 2 |
| B14 | Out14 | 0 | 0 | 4.234 | 2 |
| B15 | Out15 | 0 | 0 | 4.234 | 2 |
### buttons_toggle_real_vjoy
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 7.985 | 45 |
| B2 | Out2 | 1 | 1 | 7.985 | 45 |
| B3 | Out3 | 1 | 1 | 7.985 | 45 |
| B4 | Out4 | 1 | 1 | 7.985 | 45 |
| B5 | Out5 | 1 | 1 | 7.985 | 45 |
| B6 | Out6 | 1 | 1 | 7.985 | 45 |
| B7 | Out7 | 1 | 1 | 7.985 | 45 |
| B8 | Out8 | 1 | 1 | 7.985 | 45 |
| B9 | Out9 | 1 | 1 | 7.985 | 45 |
| B10 | Out10 | 1 | 1 | 7.985 | 45 |
| B11 | Out11 | 1 | 1 | 7.985 | 45 |
| B12 | Out12 | 1 | 1 | 7.985 | 45 |
| B13 | Out13 | 1 | 1 | 7.985 | 45 |
| B14 | Out14 | 1 | 1 | 7.985 | 45 |
| B15 | Out15 | 1 | 1 | 7.985 | 45 |
