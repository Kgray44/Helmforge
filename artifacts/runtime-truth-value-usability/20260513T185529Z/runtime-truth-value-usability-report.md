...
Generated: `2026-05-13T18:55:41.962265+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T185529Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 7.123 | 30.022 | 0.119 | 1.181 | 0.021 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 6.65 | 23.481 | 0.111 | 1.012 | 0.019 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 6.541 | 18.016 | 0.117 | 1.325 | 0.018 | 8e-06 | 8e-06 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 7.605 | 17.491 | 0.129 | 1.228 | 0.022 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 9.907 | 13.286 | 0.131 | 1.338 | 0.04 | 1e-05 | 1e-05 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 7.123 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 7.123 | 60 |
| Throttle | 8e-06 | 8e-06 | 7.123 | 60 |
| Yaw | 2e-05 | 2e-05 | 7.123 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 7.123 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 7.123 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 6.65 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 6.65 | 60 |
| Throttle | 8e-06 | 8e-06 | 6.65 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 6.65 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 6.65 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 6.65 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 7.605 | 96 |
| Pitch | 1e-05 | 1e-05 | 7.605 | 96 |
| Throttle | 6e-06 | 6e-06 | 7.605 | 96 |
| Yaw | 9e-06 | 9e-06 | 7.605 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 7.605 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 7.605 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 9.907 | 2 |
| Pitch | 4e-06 | 4e-06 | 9.907 | 2 |
| Throttle | 4e-06 | 4e-06 | 9.907 | 2 |
| Yaw | 1e-05 | 1e-05 | 9.907 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 9.907 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 9.907 | 2 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 6.541 | 45 |
| B2 | Out2 | 1 | 1 | 6.541 | 45 |
| B3 | Out3 | 1 | 1 | 6.541 | 45 |
| B4 | Out4 | 1 | 1 | 6.541 | 45 |
| B5 | Out5 | 1 | 1 | 6.541 | 45 |
| B6 | Out6 | 1 | 1 | 6.541 | 45 |
| B7 | Out7 | 1 | 1 | 6.541 | 45 |
| B8 | Out8 | 1 | 1 | 6.541 | 45 |
| B9 | Out9 | 1 | 1 | 6.541 | 45 |
| B10 | Out10 | 1 | 1 | 6.541 | 45 |
| B11 | Out11 | 1 | 1 | 6.541 | 45 |
| B12 | Out12 | 1 | 1 | 6.541 | 45 |
| B13 | Out13 | 1 | 1 | 6.541 | 45 |
| B14 | Out14 | 1 | 1 | 6.541 | 45 |
| B15 | Out15 | 1 | 1 | 6.541 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 9.907 | 2 |
...
| B8 | Out8 | 0 | 0 | 9.907 | 2 |
| B9 | Out9 | 0 | 0 | 9.907 | 2 |
| B10 | Out10 | 0 | 0 | 9.907 | 2 |
| B11 | Out11 | 0 | 0 | 9.907 | 2 |
| B12 | Out12 | 0 | 0 | 9.907 | 2 |
| B13 | Out13 | 0 | 0 | 9.907 | 2 |
| B14 | Out14 | 0 | 0 | 9.907 | 2 |
| B15 | Out15 | 0 | 0 | 9.907 | 2 |
