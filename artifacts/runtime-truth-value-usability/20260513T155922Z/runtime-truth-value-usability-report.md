...
Generated: `2026-05-13T15:59:38.662074+00:00`
Overall status: `failures_detected`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T155922Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 6.976 | 31.582 | 0.1 | 0.771 | 0.017 | 0.388807 | 0.388807 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 5.619 | 22.951 | 0.096 | 0.739 | 0.015 | 0.548801 | 0.548801 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 5.271 | 20.063 | 0.105 | 0.883 | 0.016 | 0.152445 | 0.152445 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 4.034 | 5.088 | 0.089 | 0.706 | 0.015 | 0.182346 | 0.234595 |
| `axis_sine_real_vjoy` | `real_vjoy` | 72 | 73 | 10.134 | 33.321 | 0.095 | 1.835 | 0.601 | 0.388807 | 0.388807 |
| `buttons_toggle_real_vjoy` | `real_vjoy` | 45 | 46 | 9.361 | 30.788 | 0.09 | 1.68 | 0.557 | 0.152445 | 0.152445 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 0.31009 | 0.31009 | 6.976 | 60 |
| Pitch | 0.30944 | 0.30944 | 6.976 | 60 |
| Throttle | 0.208188 | 0.208188 | 6.976 | 60 |
| Yaw | 0.388807 | 0.388807 | 6.976 | 60 |
| Aux 1 | 0.310953 | 0.310953 | 6.976 | 60 |
| Aux 2 | 0.310942 | 0.310942 | 6.976 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 0.495853 | 0.495853 | 5.619 | 60 |
| Pitch | 0.442498 | 0.442498 | 5.619 | 60 |
| Throttle | 0.246266 | 0.246266 | 5.619 | 60 |
| Yaw | 0.548801 | 0.548801 | 5.619 | 60 |
| Aux 1 | 0.240356 | 0.240356 | 5.619 | 60 |
| Aux 2 | 0.269495 | 0.269495 | 5.619 | 60 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 0.072061 | 0.212268 | 4.034 | 2 |
| Pitch | 0.041882 | 0.234595 | 4.034 | 2 |
| Throttle | 0.182346 | 0.182346 | 4.034 | 2 |
| Yaw | 0.092408 | 0.092408 | 4.034 | 2 |
| Aux 1 | 0.047421 | 0.047421 | 4.034 | 2 |
| Aux 2 | 0.026255 | 0.026255 | 4.034 | 2 |
### axis_sine_real_vjoy
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 0.31009 | 0.31009 | 10.134 | 72 |
| Pitch | 0.30942 | 0.30942 | 10.134 | 72 |
| Throttle | 0.208188 | 0.208188 | 10.134 | 72 |
| Yaw | 0.388807 | 0.388807 | 10.134 | 72 |
| Aux 1 | 0.310842 | 0.310842 | 10.134 | 72 |
| Aux 2 | 0.310942 | 0.310942 | 10.134 | 72 |
