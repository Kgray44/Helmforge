...
Generated: `2026-05-14T01:27:42.926232+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260514T012726Z`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 5.791 | 25.621 | 0.089 | 0.982 | 0.016 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 5.561 | 26.06 | 0.09 | 0.891 | 0.015 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 5.962 | 23.475 | 0.084 | 1.154 | 0.015 | 0.053974 | 0.053974 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 5.45 | 21.577 | 0.089 | 0.913 | 0.015 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 7.418 | 10.49 | 0.104 | 1.14 | 0.025 | 1e-05 | 1e-05 |
| `axis_sine_real_vjoy` | `real_vjoy` | 72 | 73 | 1.0 | 7.728 | 25.007 | 0.09 | 1.952 | 0.595 | 2e-05 | 2e-05 |
| `buttons_toggle_real_vjoy` | `real_vjoy` | 45 | 46 | 1.0 | 9.302 | 27.353 | 0.091 | 2.236 | 0.848 | 0.053974 | 0.053974 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 5.791 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 5.791 | 60 |
| Throttle | 8e-06 | 8e-06 | 5.791 | 60 |
| Yaw | 2e-05 | 2e-05 | 5.791 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 5.791 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 5.791 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 5.561 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 5.561 | 60 |
| Throttle | 8e-06 | 8e-06 | 5.561 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 5.561 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 5.561 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 5.561 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 5.45 | 96 |
| Pitch | 1e-05 | 1e-05 | 5.45 | 96 |
| Throttle | 6e-06 | 6e-06 | 5.45 | 96 |
| Yaw | 9e-06 | 9e-06 | 5.45 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 5.45 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 5.45 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 7.418 | 2 |
| Pitch | 4e-06 | 4e-06 | 7.418 | 2 |
| Throttle | 4e-06 | 4e-06 | 7.418 | 2 |
| Yaw | 1e-05 | 1e-05 | 7.418 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 7.418 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 7.418 | 2 |
### axis_sine_real_vjoy
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 7.728 | 72 |
| Pitch | 1.7e-05 | 1.7e-05 | 7.728 | 72 |
| Throttle | 7e-06 | 7e-06 | 7.728 | 72 |
| Yaw | 2e-05 | 2e-05 | 7.728 | 72 |
| Aux 1 | 1.5e-05 | 1.5e-05 | 7.728 | 72 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 7.728 | 72 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 5.962 | 45 |
| B2 | Out2 | 1 | 1 | 5.962 | 45 |
| B3 | Out3 | 1 | 1 | 5.962 | 45 |
| B4 | Out4 | 1 | 1 | 5.962 | 45 |
| B5 | Out5 | 1 | 1 | 5.962 | 45 |
| B6 | Out6 | 1 | 1 | 5.962 | 45 |
| B7 | Out7 | 1 | 1 | 5.962 | 45 |
| B8 | Out8 | 1 | 1 | 5.962 | 45 |
| B9 | Out9 | 1 | 1 | 5.962 | 45 |
| B10 | Out10 | 1 | 1 | 5.962 | 45 |
| B11 | Out11 | 1 | 1 | 5.962 | 45 |
| B12 | Out12 | 1 | 1 | 5.962 | 45 |
| B13 | Out13 | 1 | 1 | 5.962 | 45 |
| B14 | Out14 | 1 | 1 | 5.962 | 45 |
| B15 | Out15 | 1 | 1 | 5.962 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 7.418 | 2 |
...
| B8 | Out8 | 0 | 0 | 7.418 | 2 |
| B9 | Out9 | 0 | 0 | 7.418 | 2 |
| B10 | Out10 | 0 | 0 | 7.418 | 2 |
| B11 | Out11 | 0 | 0 | 7.418 | 2 |
| B12 | Out12 | 0 | 0 | 7.418 | 2 |
| B13 | Out13 | 0 | 0 | 7.418 | 2 |
| B14 | Out14 | 0 | 0 | 7.418 | 2 |
| B15 | Out15 | 0 | 0 | 7.418 | 2 |
### buttons_toggle_real_vjoy
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 9.302 | 45 |
| B2 | Out2 | 1 | 1 | 9.302 | 45 |
| B3 | Out3 | 1 | 1 | 9.302 | 45 |
| B4 | Out4 | 1 | 1 | 9.302 | 45 |
| B5 | Out5 | 1 | 1 | 9.302 | 45 |
| B6 | Out6 | 1 | 1 | 9.302 | 45 |
| B7 | Out7 | 1 | 1 | 9.302 | 45 |
| B8 | Out8 | 1 | 1 | 9.302 | 45 |
| B9 | Out9 | 1 | 1 | 9.302 | 45 |
| B10 | Out10 | 1 | 1 | 9.302 | 45 |
| B11 | Out11 | 1 | 1 | 9.302 | 45 |
| B12 | Out12 | 1 | 1 | 9.302 | 45 |
| B13 | Out13 | 1 | 1 | 9.302 | 45 |
| B14 | Out14 | 1 | 1 | 9.302 | 45 |
| B15 | Out15 | 1 | 1 | 9.302 | 45 |
