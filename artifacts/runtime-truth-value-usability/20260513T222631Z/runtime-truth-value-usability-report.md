...
Generated: `2026-05-13T22:26:50.060306+00:00`
Overall status: `passed`
Artifact directory: `artifacts\runtime-truth-value-usability\20260513T222631Z`
...
- Runtime setup HOTAS PID proof: `hardware proof deferred; supported HOTAS was not detected during this run`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `axis_sine_fake` | `fake` | 180 | 61 | 1.0 | 8.893 | 37.568 | 0.122 | 1.526 | 0.023 | 2.1e-05 | 2.1e-05 |
| `axis_sharp_step_sine_fake` | `fake` | 180 | 61 | 1.0 | 8.679 | 26.242 | 0.121 | 1.391 | 0.02 | 2.6e-05 | 2.6e-05 |
| `buttons_toggle_fake` | `fake` | 45 | 46 | 1.0 | 7.487 | 21.879 | 0.122 | 1.713 | 0.021 | 0.053974 | 0.053974 |
| `math_stage_stress_fake` | `fake` | 96 | 97 | 1.0 | 8.455 | 30.182 | 0.119 | 1.538 | 0.022 | 1e-05 | 1e-05 |
| `mapping_variant_fake` | `fake` | 2 | 3 | 1.0 | 6.315 | 6.781 | 0.111 | 1.354 | 0.026 | 1e-05 | 1e-05 |
| `axis_sine_real_vjoy` | `real_vjoy` | 72 | 73 | 1.0 | 12.812 | 29.904 | 0.126 | 3.064 | 0.925 | 2e-05 | 2e-05 |
| `buttons_toggle_real_vjoy` | `real_vjoy` | 45 | 46 | 1.0 | 12.814 | 32.435 | 0.137 | 3.4 | 1.269 | 0.053974 | 0.053974 |

## Axis Proof
### axis_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 2e-05 | 2e-05 | 8.893 | 60 |
| Pitch | 2.1e-05 | 2.1e-05 | 8.893 | 60 |
| Throttle | 8e-06 | 8e-06 | 8.893 | 60 |
| Yaw | 2e-05 | 2e-05 | 8.893 | 60 |
| Aux 1 | 1.7e-05 | 1.7e-05 | 8.893 | 60 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 8.893 | 60 |
### axis_sharp_step_sine_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 8.679 | 60 |
| Pitch | 2.2e-05 | 2.2e-05 | 8.679 | 60 |
| Throttle | 8e-06 | 8e-06 | 8.679 | 60 |
| Yaw | 2.6e-05 | 2.6e-05 | 8.679 | 60 |
| Aux 1 | 1.3e-05 | 1.3e-05 | 8.679 | 60 |
| Aux 2 | 1.4e-05 | 1.4e-05 | 8.679 | 60 |
### math_stage_stress_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1e-05 | 1e-05 | 8.455 | 96 |
| Pitch | 1e-05 | 1e-05 | 8.455 | 96 |
| Throttle | 6e-06 | 6e-06 | 8.455 | 96 |
| Yaw | 9e-06 | 9e-06 | 8.455 | 96 |
| Aux 1 | 1e-05 | 1e-05 | 8.455 | 96 |
| Aux 2 | 1e-05 | 1e-05 | 8.455 | 96 |
### mapping_variant_fake
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 9e-06 | 9e-06 | 6.315 | 2 |
| Pitch | 4e-06 | 4e-06 | 6.315 | 2 |
| Throttle | 4e-06 | 4e-06 | 6.315 | 2 |
| Yaw | 1e-05 | 1e-05 | 6.315 | 2 |
| Aux 1 | 3e-06 | 3e-06 | 6.315 | 2 |
| Aux 2 | 5e-06 | 5e-06 | 6.315 | 2 |
### axis_sine_real_vjoy
| Axis | Max final diff vs stateful intended | Max output diff vs mapped intended | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|
| Roll | 1.7e-05 | 1.7e-05 | 12.812 | 72 |
| Pitch | 1.7e-05 | 1.7e-05 | 12.812 | 72 |
| Throttle | 7e-06 | 7e-06 | 12.812 | 72 |
| Yaw | 2e-05 | 2e-05 | 12.812 | 72 |
| Aux 1 | 1.5e-05 | 1.5e-05 | 12.812 | 72 |
| Aux 2 | 1.6e-05 | 1.6e-05 | 12.812 | 72 |

## Button Proof
### buttons_toggle_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 7.487 | 45 |
| B2 | Out2 | 1 | 1 | 7.487 | 45 |
| B3 | Out3 | 1 | 1 | 7.487 | 45 |
| B4 | Out4 | 1 | 1 | 7.487 | 45 |
| B5 | Out5 | 1 | 1 | 7.487 | 45 |
| B6 | Out6 | 1 | 1 | 7.487 | 45 |
| B7 | Out7 | 1 | 1 | 7.487 | 45 |
| B8 | Out8 | 1 | 1 | 7.487 | 45 |
| B9 | Out9 | 1 | 1 | 7.487 | 45 |
| B10 | Out10 | 1 | 1 | 7.487 | 45 |
| B11 | Out11 | 1 | 1 | 7.487 | 45 |
| B12 | Out12 | 1 | 1 | 7.487 | 45 |
| B13 | Out13 | 1 | 1 | 7.487 | 45 |
| B14 | Out14 | 1 | 1 | 7.487 | 45 |
| B15 | Out15 | 1 | 1 | 7.487 | 45 |
### mapping_variant_fake
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out2 | 1 | 1 | 6.315 | 2 |
...
| B8 | Out8 | 0 | 0 | 6.315 | 2 |
| B9 | Out9 | 0 | 0 | 6.315 | 2 |
| B10 | Out10 | 0 | 0 | 6.315 | 2 |
| B11 | Out11 | 0 | 0 | 6.315 | 2 |
| B12 | Out12 | 0 | 0 | 6.315 | 2 |
| B13 | Out13 | 0 | 0 | 6.315 | 2 |
| B14 | Out14 | 0 | 0 | 6.315 | 2 |
| B15 | Out15 | 0 | 0 | 6.315 | 2 |
### buttons_toggle_real_vjoy
| Button | Expected output button | Input true observed | Output true observed | Avg total latency ms | Writes observed |
|---|---:|---:|---:|---:|---:|
| B1 | Out1 | 1 | 1 | 12.814 | 45 |
| B2 | Out2 | 1 | 1 | 12.814 | 45 |
| B3 | Out3 | 1 | 1 | 12.814 | 45 |
| B4 | Out4 | 1 | 1 | 12.814 | 45 |
| B5 | Out5 | 1 | 1 | 12.814 | 45 |
| B6 | Out6 | 1 | 1 | 12.814 | 45 |
| B7 | Out7 | 1 | 1 | 12.814 | 45 |
| B8 | Out8 | 1 | 1 | 12.814 | 45 |
| B9 | Out9 | 1 | 1 | 12.814 | 45 |
| B10 | Out10 | 1 | 1 | 12.814 | 45 |
| B11 | Out11 | 1 | 1 | 12.814 | 45 |
| B12 | Out12 | 1 | 1 | 12.814 | 45 |
| B13 | Out13 | 1 | 1 | 12.814 | 45 |
| B14 | Out14 | 1 | 1 | 12.814 | 45 |
| B15 | Out15 | 1 | 1 | 12.814 | 45 |
