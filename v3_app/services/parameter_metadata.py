...
class ParameterHelpRegistry:
    ...
    def get(self, parameter_id: str) -> ParameterMetadata | None:
...
def _base_tuning_metadata() -> tuple[ParameterMetadata, ...]:
    return (
        _dropdown(
            ...
            "Base Tuning",
            "Parameters",
            "Chooses the shape family used before strength is applied.",
            "The current runtime uses the recovered S-curve style by default. Other curve families stay hidden until implemented.",
            ("s",),
            "s",
            "The recovered S-curve path keeps behavior aligned with the current pipeline.",
            "Additional curve families stay hidden until the pipeline supports them.",
            topic="Base Tuning",
        ),
        _number(
            "base.curve_strength",
            ...
            "Base Tuning",
            "Parameters",
            "Controls how strongly the curve reshapes the selected axis.",
            "Lower values feel closer to linear. Higher values make the center or edge response more shaped.",
            0.0,
            1.0,
            0.34,
            "Near zero keeps the stick close to raw input.",
            "Near one makes the curve shaping obvious.",
            recommended=(0.10, 0.70),
            warning="Extreme values can make fine control feel either too flat or too jumpy.",
            topic="Base Tuning",
        ),
        _number(
            "base.deadzone",
            ...
            "Base Tuning",
            "Parameters",
            "Ignores small input near center before output starts moving.",
            "Use this to calm noisy center drift without hiding deliberate movement.",
            0.0,
            0.50,
            0.03,
            "0.00 responds to the smallest motion.",
            "0.50 ignores half of the input travel near center.",
            recommended=(0.00, 0.08),
            warning="Large deadzones can make the control feel unresponsive.",
            topic="Base Tuning",
        ),
        _number(
            "base.anti_deadzone",
            ...
            "Base Tuning",
            "Parameters",
            "Adds an initial output jump after leaving center.",
            "Use sparingly when a target simulator ignores tiny output values.",
            0.0,
            0.50,
            0.0,
            "0.00 adds no initial jump.",
            "0.50 jumps aggressively after center.",
            recommended=(0.00, 0.10),
            warning="High anti-deadzone can make small corrections lurch.",
            topic="Base Tuning",
        ),
        _number(
            "base.hysteresis",
            ...
            "Base Tuning",
            "Parameters",
            "Adds a small hold band to reduce center chatter.",
            "It can calm noisy sensors, but too much can make reversals feel sticky.",
            0.0,
            0.50,
            0.0,
            "0.00 tracks reversals immediately.",
            "0.50 strongly resists small reversals.",
            recommended=(0.00, 0.06),
            warning="High hysteresis can hide intentional small inputs.",
            topic="Base Tuning",
        ),
        _number(
            "base.output_scale",
            ...
            "Base Tuning",
            "Parameters",
            "Multiplies the processed output before final limiting.",
            "Use this for broad authority changes while keeping the curve shape intact.",
            0.0,
            2.0,
            1.0,
            "0.00 mutes the axis output.",
            "2.00 doubles authority before final limiting.",
            recommended=(0.50, 1.20),
            warning="Values above 1.00 can hit limits sooner.",
            topic="Base Tuning",
        ),
        _number(
            "base.max_output",
            ...
            "Base Tuning",
            "Parameters",
            "Caps the final output magnitude for the selected axis.",
            "Use this when a simulator or profile should never receive full authority.",
            0.0,
            1.0,
            1.0,
            "0.00 prevents output authority.",
            "1.00 allows the full normalized output range.",
            recommended=(0.50, 1.00),
            warning="Low caps can make full stick travel feel weak.",
            topic="Base Tuning",
        ),
    )
...
def _filtering_metadata() -> tuple[ParameterMetadata, ...]:
    return (
        _number(
            ...
            "Filtering",
            "Parameters",
            "Controls smoothing strength near the center of the axis.",
            "Lower alpha feels smoother and slower. Higher alpha follows input more quickly.",
            0.0,
            1.0,
            0.35,
            "0.00 heavily damps center changes.",
            "1.00 follows raw center movement immediately.",
            recommended=(0.20, 0.65),
            topic="Filtering",
        ),
        _number(
            ...
            "Filtering",
            "Parameters",
            "Controls smoothing strength near the outside of the axis travel.",
            "Use higher edge alpha when large movements should stay responsive.",
            0.0,
            1.0,
            0.70,
            "0.00 heavily damps edge changes.",
            "1.00 follows edge movement immediately.",
            recommended=(0.50, 0.90),
            topic="Filtering",
        ),
        _number(
            ...
            "Filtering",
            "Parameters",
            "Limits how fast output can keep moving in the same direction.",
            "This is useful for damped cinematic profiles or unstable inputs.",
            0.0,
            1.0,
            1.0,
            "0.00 nearly stops same-direction motion.",
            "1.00 allows full same-direction movement.",
            recommended=(0.60, 1.00),
            topic="Filtering",
        ),
        _number(
            ...
            "Filtering",
            "Parameters",
            "Limits how fast output can reverse direction.",
            "Lower values smooth snap-backs. Higher values make reversals immediate.",
            0.0,
            1.0,
            0.65,
            "0.00 resists reversals strongly.",
            "1.00 lets reversals track immediately.",
            recommended=(0.35, 0.85),
            warning="Very low reversal limits can make aiming feel delayed.",
            topic="Filtering",
        ),
    )
...
def _combat_metadata() -> tuple[ParameterMetadata, ...]:
    return (
        _number(
            ...
            "Combat Profile",
            "Parameters",
            "Applies extra curve shaping while combat behavior is active.",
            "Use it to make zoom or combat movement more precise than the base profile.",
            0.0,
            1.0,
            0.45,
            "0.00 keeps combat close to baseline.",
            "1.00 makes combat shaping strong.",
            recommended=(0.20, 0.70),
            topic="Combat Profile",
        ),
        _number(
            "combat.combat_scale",
            "Combat Scale",
            "Combat Profile",
            "Parameters",
            "Scales final authority during combat behavior.",
            "Lower values calm movement while aiming. Higher values preserve full authority.",
            0.0,
            2.0,
            0.85,
            "0.00 mutes combat output authority.",
            "2.00 doubles combat authority before caps.",
            recommended=(0.50, 1.00),
            warning="Values above 1.00 can hit output caps sooner.",
            topic="Combat Profile",
        ),
        _number(
            ...
            "Combat Profile",
            "Parameters",
            "Controls center smoothing while combat behavior is active.",
            "Lower values feel steadier for tiny aim corrections.",
            0.0,
            1.0,
            0.25,
            "0.00 heavily damps center movement.",
            "1.00 follows center movement immediately.",
            recommended=(0.15, 0.55),
            topic="Combat Profile",
        ),
        _number(
            ...
            "Combat Profile",
            "Parameters",
            "Controls edge smoothing while combat behavior is active.",
            "Higher values keep large combat movements responsive.",
            0.0,
            1.0,
            0.60,
            "0.00 heavily damps large movements.",
            "1.00 follows large movements immediately.",
            recommended=(0.40, 0.85),
            topic="Combat Profile",
        ),
        _number(
            ...
            "Combat Profile",
            "Parameters",
            "Limits same-direction movement while combat behavior is active.",
            "Use this to make tracking smoother without changing the base profile.",
            0.0,
            1.0,
            0.80,
            "0.00 nearly stops same-direction combat motion.",
            "1.00 allows full same-direction combat motion.",
            recommended=(0.50, 1.00),
            topic="Combat Profile",
        ),
        _number(
            ...
            "Combat Profile",
            "Parameters",
            "Limits reversal speed while combat behavior is active.",
            "Lower values soften snap corrections; higher values preserve quick reversals.",
            0.0,
            1.0,
            0.50,
            "0.00 resists combat reversals strongly.",
            "1.00 lets combat reversals track immediately.",
            recommended=(0.25, 0.80),
            warning="Very low reversal limits can feel sluggish during aiming.",
            topic="Combat Profile",
        ),
    )
...
def _modes_metadata() -> tuple[ParameterMetadata, ...]:
    return (
        _text(
            ...
            "Modes",
            "Precision Mode",
            "Lists buttons that engage precision scaling while held.",
            "Use comma-separated button numbers. The current default recovered button is 0.",
            "0",
            "No buttons means precision mode will not engage.",
            "Configured buttons can engage precision behavior.",
            topic="Modes",
        ),
        _text(
            ...
            "Modes",
            "Combat Mode",
            "Lists trigger buttons that may engage combat behavior.",
            "Leave empty when combat should not depend on trigger buttons.",
            "",
            "Empty keeps this trigger gate inactive.",
            "Configured buttons can gate combat behavior.",
            topic="Modes",
        ),
        _text(
            ...
            "Modes",
            "Combat Mode",
            "Lists zoom or aim buttons that engage combat behavior.",
            "The recovered default uses button 5 for zoom or aim mode.",
            "5",
            "Empty removes the zoom or aim gate.",
            "Configured buttons can activate combat behavior while aiming.",
            topic="Modes",
        ),
        _text(
            ...
            "Modes",
            "Combat Mode",
            "Lists extra buttons that can also gate combat behavior.",
            "Use this for extra mode triggers without changing the core trigger list.",
            "",
            "Empty keeps extra gating inactive.",
            "Configured extra buttons add another combat entry path.",
            topic="Modes",
        ),
        _dropdown(
            "modes.stack_mode",
            ...
            "Modes",
            "Combat Mode",
            "Controls how precision and combat modifiers combine.",
            "Only multiply is currently supported by the recovered runtime model.",
            ("multiply",),
            "multiply",
            "Multiply preserves the current supported behavior.",
            "Multiply remains the only active option in this build.",
            topic="Modes",
        ),
    )
