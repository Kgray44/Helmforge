...
PAGE_DEFINITIONS = (
    ...
    PageDefinition("flight_recorder", "Flight Recorder", "Review the recorder shell, metadata-only clip library, preview area, and future telemetry overlay.", "Flight Recorder remains metadata-only until capture, encoding, and hindsight video buffering are implemented and verified."),
