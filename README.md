...
Phase 9G does **not** provide real support for that hardware. It does **not** implement real HOTAS polling, real vJoy output writes, output verification, automatic Bridge launch, process spawning from the UI, Windows Service installation, login auto-start, installer launch, tray manager work, or real runtime activation. No live runtime support should be claimed until a later phase implements and verifies it.
